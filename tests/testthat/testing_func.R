...
test_that("driver_winner() method works", {
  ...
  expect_output(driver_winner(2022), "Max Verstappen won the most race which is 15 races with 454 points in 2022")
})

# 7) check the name of the driver who drive most between years a and b
test_that("driver_winner_period() method works", {
  expect_output(driver_winner_period(2020,2022), "Max Verstappen has the highest number of wins with 27 wins in total between years 2020 and 2022")
...
test_that("const_winner() method works", {
  ...
  expect_output(const_winner(2022), "Red Bull constructer won the most race which is 17 races with 759 points in 2022")
})
...
test_that("const_winner_period() method works", {
  ...
  expect_output(const_winner_period(2020, 2022), "Red Bull constructor has the highest number of wins with 30 wins in total between years 2020 and 2022")
})
